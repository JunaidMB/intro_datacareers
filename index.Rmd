...
```{r, fig.align='center',out.height = "400px", out.width="450px", echo=FALSE}
knitr::include_graphics("assets/img/conway_datascience_venn_diagram.png")
```
...
```{r, fig.align='center',out.height = "400px", out.width="400px", echo=FALSE}
knitr::include_graphics("assets/img/revolut_data_analyst_job_description.png")
```
...
```{r, fig.align='center',out.height = "450px", out.width="450px", echo=FALSE}
knitr::include_graphics("assets/img/zego_data_science_job_description.png") 
```
...
```{r, fig.align='center',out.height = "350px", out.width="350px", echo=FALSE}
knitr::include_graphics("assets/img/nectar360_senior_analyst_job_description.png")
```
...
```{r, fig.align='center',out.height = "500px", out.width="500px", echo=FALSE}
knitr::include_graphics("assets/img/monzo_datascience_job_description.png")
```
...
```{r, fig.align='center',out.height = "500px", out.width="500px", echo=FALSE}
knitr::include_graphics("assets/img/facebook_datascience_job_description.png")
```
...
```{r, fig.align='center',out.height = "550px", out.width="550px", echo=FALSE}
knitr::include_graphics("assets/img/tractable_datascience_job_description.png")
```
...
```{r, fig.align='center',out.height = "450px", out.width="450px", echo=FALSE}
knitr::include_graphics("assets/img/tractable_mlengineer_job_description1.png")

knitr::include_graphics("assets/img/tractable_mlengineer_job_description2.png")
```
...
```{r, fig.align='center',out.height = "450px", out.width="450px", echo=FALSE}
knitr::include_graphics("assets/img/facebook_mlengineer_job_description.png")
```
...
```{r, fig.align='center',out.height = "350px", out.width="400px", echo=FALSE}
knitr::include_graphics("./assets/img/ppdac_cycle.png")
```
